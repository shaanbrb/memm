...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      aria-pressed={dark}
      className="relative flex h-6 w-11 items-center rounded-full bg-surface-2 p-[3px] transition-colors hover:bg-accent"
    >
      <motion.span
        layout
        transition={{ type: "spring", stiffness: 420, damping: 34 }}
        className="flex size-[18px] items-center justify-center rounded-full bg-foreground text-background"
