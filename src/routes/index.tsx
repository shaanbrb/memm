...
function TechnicalGrid() {
  return (
    <div
      aria-hidden="true"
      className="technical-grid pointer-events-none absolute inset-0 z-0"
    />
  );
}
...
function Hero() {
  ...
  return (
    ...
    >
      <motion.div
        style={{ opacity: fade }}
        className="relative z-10 mx-auto w-full max-w-[74rem] px-6 pb-16 pt-28 md:px-10 md:pb-24 md:pt-32"
      >
        ...
        >
          <p className="max-w-md text-[15px] lowercase leading-[1.8] text-muted-foreground">
            pick one of thousands of templates, type your caption,
            download the png.
          </p>
          <Link
            to="/studio"
  ...
  return (
    ...
    >
      <Reveal className="mx-auto max-w-2xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-[16px] lowercase leading-[1.8] text-foreground/75">
  ...
  return (
    <section className="overflow-hidden py-8">
      ...
      <div className="mx-auto mt-8 max-w-[74rem] px-6 md:px-10">
        <Label>thousands of templates, searchable by name</Label>
      </div>
    </section>
  );
}
...
function Closer() {
  return (
    <section className="relative overflow-hidden">
      <TechnicalGrid />
      <div className="relative z-10 mx-auto max-w-[74rem] px-6 py-36 text-center md:px-10 md:py-48">
        <Reveal>
